...
{ int exit ;
  ...
  spu_sgemm_tile(__cil_tmp5, __cil_tmp6, __cil_tmp7);
  break;
  case 1: 
  __cil_tmp8 = task_info->ls_addr;
  __cil_tmp9 = (float *)__cil_tmp8;
  __cil_tmp8 += ex_task->arguments[0].size;
  __cil_tmp10 = (float *)__cil_tmp8;
  spu_ssyrk_tile(__cil_tmp9, __cil_tmp10);
  break;
  case 2: 
  __cil_tmp11 = task_info->ls_addr;
  __cil_tmp12 = (float *)__cil_tmp11;
  spu_spotrf_tile(__cil_tmp12);
  break;
  case 3: 
  __cil_tmp13 = task_info->ls_addr;
  __cil_tmp14 = (float *)__cil_tmp13;
  __cil_tmp13 += ex_task->arguments[0].size;
  __cil_tmp15 = (float *)__cil_tmp13;
  spu_strsm_tile(__cil_tmp14, __cil_tmp15);
  break;
  default: 
  exit = 1;
  break;
