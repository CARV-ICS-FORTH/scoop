...
#ifndef X264_ME_TPC_H
#define X264_ME_TPC_H
...
void x264_me_search_ref_tpc( x264_data_t *data, x264_me_t *m, int16_t (*mvc)[2], int i_mvc, int *p_fullpel_thresh, x264_mb_t *mb );

static inline void x264_me_search_tpc( x264_data_t *data, x264_me_t *m, int16_t (*mvc)[2], int i_mvc, x264_mb_t *mb )
    { x264_me_search_ref_tpc( data, m, mvc, i_mvc, NULL, mb ); }
...
int x264_me_refine_bidir_tpc( x264_data_t *data, x264_me_t *m0, x264_me_t *m1, int i_weight , x264_mb_t *mb );
uint64_t x264_rd_cost_part_tpc( x264_data_t *data, int i_lambda2, int i8, int i_pixel, x264_mb_t *mb  );
