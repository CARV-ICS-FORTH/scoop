...
int x264_macroblock_probe_skip_tpc( x264_t *h, int b_bidir, x264_mb_t *mb );

void x264_macroblock_encode_tpc      ( x264_t *h, x264_mb_t *mb, x264_dct_t *dct );

static inline int x264_macroblock_probe_pskip_tpc( x264_t *h, x264_mb_t *mb )
    { return x264_macroblock_probe_skip_tpc( h, 0, mb ); }
static inline int x264_macroblock_probe_bskip_tpc( x264_t *h, x264_mb_t *mb )
    { return x264_macroblock_probe_skip_tpc( h, 1, mb ); }
