...
#define X264_ME_OLD_ESA              5 
#define X264_ME_OLD_HEX              6  
...
static const char * const x264_motion_est_names[] = { "dia", "hex", "umh", "esa", "tesa", "old_esa", "old_hex", 0 };
...
#ifdef TPC
    /* Cell */
    int spes;			/* number of SPEs to use */
#endif

} __attribute__ ((aligned (128))) x264_param_t;
