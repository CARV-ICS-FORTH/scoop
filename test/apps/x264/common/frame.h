...
} __attribute__ ((aligned (16))) x264_frame_t;

//#ifdef TPC
#if 0
typedef void (*x264_deblock_inter_t)( x264_t *h, uint8_t *pix, int stride, int alpha, int beta, int8_t *tc0 );
typedef void (*x264_deblock_intra_t)( x264_t *h, uint8_t *pix, int stride, int alpha, int beta );
#else
