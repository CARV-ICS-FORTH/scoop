 ...
 * Exported functions:
 ****************************************************************************/
void x264_predict_16x16_init_tpc( int cpu, x264_predict_tpc_t pf[7] )
{
    pf[I_PRED_16x16_V ]     = predict_16x16_v_tpc;
    pf[I_PRED_16x16_H ]     = predict_16x16_h_tpc;
    pf[I_PRED_16x16_DC]     = predict_16x16_dc_tpc;
    pf[I_PRED_16x16_P ]     = predict_16x16_p_tpc;
    pf[I_PRED_16x16_DC_LEFT]= predict_16x16_dc_left_tpc;
    pf[I_PRED_16x16_DC_TOP ]= predict_16x16_dc_top_tpc;
    pf[I_PRED_16x16_DC_128 ]= predict_16x16_dc_128_tpc;
