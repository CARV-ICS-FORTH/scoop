...
uint8_t *get_ref( uint8_t *dst,   int *i_dst_stride,
                         ...
                         int mvx, int mvy,
                         int i_width, int i_height );
void pixel_avg_16x16( uint8_t *pix1, int i_stride_pix1,
...
typedef void  (*x264_pixel_avg_t) ( uint8_t *dst, int, uint8_t *src1, int, uint8_t *src2, int, int i_weight );

extern x264_pixel_avg_t avgf[10];
