...
#ifdef HPAGE
	 h->mb.non_zero_count = allocate_from_huge( i_mb_count * 32 * sizeof(uint8_t) );
#else
     CHECKED_MALLOC( h->mb.non_zero_count, i_mb_count * 32 * sizeof(uint8_t) );
    //CHECKED_MALLOC( h->mb.non_zero_count, i_mb_count * 128 * sizeof(uint8_t) );
